...
<head>
  ...
  <meta name="description" content="Sistema de vendas, página de cadastro de usuários - WR Vendas">
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url('assets/img/apple-icon.png'); ?>">
  <link rel="icon" type="image/png" href="<?php echo base_url('assets/img/favicon.png'); ?>">
  <title>WR Vendas | Painel Cadatro de Usuários</title>
            ...
            <div class="card card-chart">
              ...
              <form action="<?php echo base_url('cadastroUsuario/registerUser') ?>" method="POST">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        <input type="password" class="form-control" name="confSenha" placeholder="Repita sua senha" required>
                    </div>
                </div> 
                <hr class="divisao"/>
